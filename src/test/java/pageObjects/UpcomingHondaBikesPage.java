...
//	WebElement upcomingBikes;
	...
	@FindBy(css = "li[data-track-label='upcoming-tab']")
	WebElement upcomingBikes;
	
	
	@FindBy(css = "a[title='All Upcoming Bikes']")
	...
	//To select all upcoming bikes 
	public void navigateToAllUpcommingBikes() {
		action.moveToElement(allupcomingbikes).build().perform();
